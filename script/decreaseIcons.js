...
giftsFiltred.forEach(function(element){
    ...
    localStorage.setItem('iconsWidth', element.style.width);
    let elHeight = +element.querySelector('img').style.minHeight.slice(0,-2);
    element.querySelector('img').style.minHeight = elHeight - 5 + 'px';
    localStorage.setItem('iconsHeight', element.querySelector('img').style.minHeight);
    if (element.querySelector('.messi_plus')) {
        ...
        localStorage.setItem('plusTop', element.querySelector('.messi_plus').style.top);
        localStorage.setItem('plusLeft', element.querySelector('.messi_plus').style.left);
    }
